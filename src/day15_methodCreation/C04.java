...
public class C04 {
    //main method olmadanda bir class oluşturulabilir
    //ancak bu class direk çalışmaz sadece depogörevi görürü
    //baska class lardaan kullanılabilecek method veya variable ları barındırır
