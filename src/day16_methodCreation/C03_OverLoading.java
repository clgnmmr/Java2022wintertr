...
public class C03_OverLoading {
    public static void main(String[] args) {
        ...
        //verilen iki sayıyı toplayan ve yazdıran bir method oluşturun

        int sayi1=10;
        int sayi2=20;

        ikiSayiToplama(sayi1, sayi2);
        // iki double sayinin toplamini yazdiran bir method aloşturalım
    ...
    private static void ikiSayiToplama(int sayi1, int sayi2) {
